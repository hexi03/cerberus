...
{
    [MetadataType(typeof(WHReplenishmentReportFormDTOMetadata))]
    public class WHReplenishmentReportFormDTO : ReportDTO
    {
        public int warehouse_id { get; set; }
        public Dictionary<string, string> items { get; set; }

        private class WHReplenishmentReportFormDTOMetadata
        {
        ...
        public class Mapper
        {
            public static WHReplenishmentReportFormDTO map(WHReplenishmentReport rep)
            {
                var res = new WHReplenishmentReportFormDTO();
